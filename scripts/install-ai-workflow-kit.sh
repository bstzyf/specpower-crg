...
cat > .claude/commands/spcrd-start.md <<'AIWK_EOF'
...
cat > .claude/commands/spcrd-plan.md <<'AIWK_EOF'
# Spcrd Plan
...
cat > .claude/commands/spcrd-dev.md <<'AIWK_EOF'
# Spcrd Development
...
cat > .claude/commands/spcrd-review.md <<'AIWK_EOF'
# Spcrd Review
...
cat > .claude/commands/spcrd-archive.md <<'AIWK_EOF'
# Spcrd Archive
...
cat > .claude/commands/spcrd-bugfix.md <<'AIWK_EOF'
...
cat > .claude/commands/spcrd-hotfix.md <<'AIWK_EOF'
...
cat > .claude/commands/spcrd-refactor.md <<'AIWK_EOF'
...
cat > .claude/commands/spcrd-audit.md <<'AIWK_EOF'
